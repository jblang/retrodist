...
CDROM_SOURCE="infomagic/ldr/1994_12"

# extract configuration
EXTRACT_MEDIA="disc1.iso"
EXTRACT_INSTALL_PATH="distributions/slackware"
EXTRACT_BOOT_PATH="distributions/slakinst/boot144/bare"
EXTRACT_ROOT_PATH="distributions/slakinst/root144/tty144"
