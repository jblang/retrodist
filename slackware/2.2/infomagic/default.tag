...
a    gpm          REC   # General purpose mouse support v0.97
a    grep         ADD   # GNU grep 2.0
a    gzip         ADD   # GNU zip compression utilities. (v. 1.2.4)
a    hdsetup      ADD   # The Slackware setup/package maintenance system v. 2.2.0
a    idenet       REC   # Linux kernel version 1.2.1, without SCSI support.
a    keytbls      OPT   # kbd 0.89
a    ldso         ADD   # ld.so 1.5.3, the dynamic linker/loader.
a    less         ADD   # less-252
...
a    scsi         REC   # Linux kernel version 1.2.1, with SCSI + IDE support.
...
ap   shlbsvga     REC   # Shared library libsvga.so.1.2.4 (from svgalib124)
...
d    lx121_1      REC   # Linux kernel source version 1.2.1, part one.
d    lx121_2      REC   # Linux kernel source version 1.2.1, part two. (include files)
d    lx121_3      REC   # Linux kernel source version 1.2.1, part three.
d    m4           REC   # GNU m4 1.4
...
d    svgalib      OPT   # Svgalib Super-VGA Graphics Library (v124)
...
n    sendmail     REC   # BSD sendmail 8.6.11.
...
q    *            SKP
q    aztech1      OPT   # Linux kernel 1.2.1 with Aztech/Orchid/Wearnes CD-ROM drivers.
q    aztech2      OPT   # Linux kernel 1.2.1 with Aztech/Orchid/Wearnes CD-ROM drivers.
q    bare         OPT   # Linux kernel 1.2.1 with IDE hard drive support.
q    cdu31a1      OPT   # Linux kernel version 1.2.1, with Sony CDU31A/CDU33A driver.
q    cdu31a2      OPT   # Linux kernel version 1.2.1, with Sony CDU31A/CDU33A driver.
q    cdu535_1     OPT   # Linux kernel version 1.2.1, with Sony 531/535 driver.
q    cdu535_2     OPT   # Linux kernel version 1.2.1, with Sony 531/535 driver.
q    idecd1       OPT   # Linux kernel version 1.2.1, with IDE/ATAPI CD-ROM support.
q    idecd2       OPT   # Linux kernel version 1.2.1, with IDE/ATAPI CD-ROM support.
q    idenet       OPT   # Linux kernel version 1.2.1, with IDE and network drivers.
q    mitsumi1     OPT   # Linux kernel version 1.2.1, with SCSI+IDE+Mitsumi CD support.
q    mitsumi2     OPT   # Linux kernel version 1.2.1, with SCSI+IDE+Mitsumi CD support.
q    sbpcd1       OPT   # Linux kernel version 1.2.1, with SCSI+IDE+Soundblaster CD support.
q    sbpcd2       OPT   # Linux kernel version 1.2.1, with SCSI+IDE+Soundblaster CD support.
q    scsi         OPT   # Linux kernel version 1.2.1, with SCSI + IDE support.
q    scsinet1     OPT   # Linux kernel version 1.2.1, with SCSI + IDE support.
q    scsinet2     OPT   # Linux kernel version 1.2.1, with SCSI + IDE support.
q    xt           OPT   # Linux kernel version 1.2.1, with IDE+XT (MFM/RLL) drive support.
