This is Slackware Linux 3.2.0.

This version contains the 2.0.29 Linux kernel, plus recent versions of these
...
- Gpm                    1.10
- SysVinit               2.69
- Shadow Password Suite  3.3.2 (with Linux patches)
- Util-linux             2.6
...
./a1 - ./a9     The base system. Enough to get up and running and have elvis
                and comm programs available. Based around the 2.0.29 Linux
...
./d1 - ./d13    Program development. GCC/G++/ObjectiveC/Fortran-77 2.7.2.1, 
                make (GNU and BSD), byacc and GNU bison, flex, 5.4.23 C 
...
./k1 - ./k6     Source code for the 2.0.29 Linux kernel.
...
./y1 - ./y2     Games.  The BSD games collection, Tetris for terminals, 
                Koules, Lizards, and Sasteroids.
...
./x1 - ./x22    The base XFree86 3.2 system, with libXpm, fvwm 1.23b, and 
...
Installation notes for Slackware Linux 3.2.0:
