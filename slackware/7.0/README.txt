...
README for Slackware Linux 7.0.0.

Slackware 7 is a complete distribution of the Linux operating system.  This
version contains the 2.2.13 Linux kernel, plus recent versions of these (and
other) software packages:

- Kernel modules         2.2.13
- PPP daemon             2.3.10
- Dynamic linker (ld.so) 1.9.9
- C compiler             egcs-1.1.2, gcc-2.7.2.3, and gcc-2.95.
- Binutils               2.9.1.0.25
- C Library              glibc-2.1.2
- C++ Library            libstdc++-2-libc6.1-1-2.9.0
- Procps                 2.0.2
- Gpm                    1.17.8
- SysVinit               2.76-4
- Shadow Password Suite  shadow-19990607
- Util-linux             util-linux-2.9v
...
slakware/a1 - slakware/a13:  The base system.  Enough to get up and running and
                ...
                2.2.13 Linux kernel, and concepts from the Linux filesystem
...
slakware/d1:    Program development.  egcs-1.1.2 (gcc-2.8 based C/C++/f77/
                ...
                byacc and GNU bison, flex, glibc-2.1.2, gdb, SVGAlib, ncurses,
...
slakware/e1:    GNU Emacs 20.4.  This is a text editor with about a million
...
slakware/k1:    Source code for the 2.2.13 Linux kernel.  You'll need this
...
slakware/x1:    The X Window System (XFree86 3.3.5) with libXpm, fvwm2-2.2.2,
...
bigslack        This is similar to ZipSlack, but includes a much more
                complete system using about 750 megabytes of drive space.
                Includes X, KDE, networking apps, servers, development tools.
                The works.
