...
Slackware 2.0.1 was released in October 1994. Refer to the [README](./infomagic/README.txt) from the CD-ROM for details of the release.
...
If you want the original Slackware 2.0.1 installer flow instead:
