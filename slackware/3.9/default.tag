...
a    fsmods       ADD   # Filesystem modules for Linux 2.0.37pre10.
...
a    hdsetup      ADD   # The Slackware setup/package maintenance system v. 3.9.0
a    ibcs2        OPT   # Intel Binary Compatibility Specification module
a    ide          REC   # Linux kernel version 2.0.37pre10, without SCSI support.
a    kbd          REC   # kbd 0.95
...
a    modules      ADD   # Linux kernel modules for 2.0.37pre10.
...
a    scsi         REC   # Linux kernel version 2.0.37pre10, with SCSI support.
a    scsimods     ADD   # Linux SCSI, RAID, and CD-ROM kernel modules for Linux 2.0.37pre10.
...
d    linuxinc     ADD   # Linux 2.0.37pre10 kernel include files
...
k    *            SKP
k    linuxinc     REC   # Linux 2.0.37pre10 kernel include files.
k    lx2037       REC   # Linux kernel source version 2.0.37pre10.
...
n    netmods      ADD   # Network support modules for linux-2.0.37pre10.
