This is Slackware Linux 3.9.0.

Slackware 3.9 is a conversion of the Slackware 4.0 release to use a 2.0 kernel
instead of a 2.2 kernel.  Because of its proven stability, many people have
expressed an interest in continued support for the 2.0.x kernel series.  This
version contains the 2.0.37pre10 Linux kernel, plus recent versions of these
(and other) software packages:

- Kernel modules         2.0.37pre10
...
slakware/a1 - slakware/a13:  The base system.  Enough to get up and running and
                ...
                2.0.37pre10 Linux kernel, and concepts from the Linux
                filesystem standard.  Installing the entire A series requires
                40 MB.
...
slakware/k1:    Source code for the 2.0.37pre10 Linux kernel.  You'll need this
                (along with the C compiler and utilities from the D series) if
                you want to recompile your Linux kernel.  Installing the K
                series will require 30 MB, and you'll need more to compile it.
