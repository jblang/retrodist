...
a    fsmods       ADD   # Filesystem modules for Linux 2.2.16
a    getty        OPT   # getty_ps 2.0.7j
a    glibcso      ADD   # glibc-2.1.3 runtime support
a    gpm          REC   # gpm-1.19.2
a    grep         ADD   # GNU grep 2.4.2
a    gzip         ADD   # GNU zip compression utilities. (v. 1.2.4a)
a    hdsetup      ADD   # The Slackware setup/package maintenance system v. 7.1.0
a    ibcs2        OPT   # Intel Binary Compatibility Specification module
a    ide          REC   # Linux kernel version 2.2.16, without SCSI support
...
a    lilo         ADD   # LILO 21.4.3
a    loadlin      REC   # LOADLIN v1.6a
a    lpr          REC   # lpr-0.48-1
a    man          ADD   # man-1.5h1
a    minicom      REC   # Minicom 1.82.1
a    modules      ADD   # Linux kernel modules for 2.2.16
a    modutils     ADD   # modutils-2.3.11
a    pciutils     OPT   # pciutils-2.1.8 (Linux PCI utilities)
a    pcmcia       REC   # pcmcia-cs-3.1.16
a    procps       ADD   # procps-2.0.6, psmisc-18, procinfo-17
a    scsi         REC   # Linux kernel version 2.2.16, with SCSI support
a    scsimods     ADD   # Linux SCSI, RAID, and CD-ROM kernel modules for Linux 2.2.16
a    sh_utils     ADD   # GNU sh-utils-2.0
a    shadow       ADD   # Shadow password suite (shadow-19990607)
a    sndmods      ADD   # Linux sound modules for 2.2.16
a    sysklogd     ADD   # Sysklogd 1.3-33
a    sysvinit     ADD   # sysvinit-2.78
a    tar          ADD   # GNU tar 1.13
a    tcsh         REC   # tcsh 6.09
a    txtutils     ADD   # GNU textutils-2.0
a    umsprogs     ADD   # umsdos-progs-1.12
a    util         ADD   # util-linux 2.10l - A huge collection of essential utilities
...
ap   sc           OPT   # The 'sc' spreadsheet. (v. 7.2)
ap   seejpeg      REC   # seejpeg-1.10
ap   sox          REC   # sox-12.15
ap   sudo         OPT   # sudo-1.6.3p4
ap   texinfo      REC   # GNU texinfo-4.0
ap   vim          OPT   # Version 5.6 of Vim: Vi IMproved
ap   workbone     OPT   # Workbone 2.31-5
ap   zsh          OPT   # zsh version 3.0.8
...
d    libtool      OPT   # GNU libtool 1.3.5
d    linuxinc     ADD   # Linux 2.2.16 kernel include files
d    m4           REC   # GNU m4 1.4
d    ncurses      REC   # ncurses-5.0 (19991023-release)
d    p2c          OPT   # p2c-1.21alpha2
d    perl         REC   # perl-5.6.0
...
gtk  bugbuddy     OPT   # bug-buddy-1.0
gtk  control      ADD   # control-center-1.2.0
gtk  econf        ADD   # enlightenment-conf-0.15
gtk  ee           REC   # ee-0.3.11
gtk  enlight      ADD   # enlightenment-0.16.4.
gtk  esound       ADD   # esound-0.2.18
gtk  eterm        ADD   # Eterm-0.8.10
gtk  fnlib        ADD   # fnlib-0.5
gtk  freefont     ADD   # freefonts-0.10
gtk  freetype     ADD   # freetype-1.3.1
gtk  gdkpixbf     ADD   # gdk-pixbuf-0.8.0
gtk  gdm          ADD   # gdm-2.0beta4
gtk  gedit        ADD   # gedit-0.5.1
gtk  gftp         ADD   # gftp-2.0.6a
gtk  ggv          REC   # ggv-0.95
gtk  gimp         ADD   # The GIMP -- GNU Image Manipulation Program version 1.0.4
gtk  gladedev     OPT   # glade-0.5.9
gtk  gmc          ADD   # mc-4.5.50
gtk  gmp          ADD   # gmp-3.0.1
gtk  gnoadmin     ADD   # gnome-admin-1.0.3
gtk  gnoaudio     ADD   # gnome-audio-1.0.0
gtk  gnogames     ADD   # gnome-games-1.2.0
gtk  gnoguide     ADD   # users-guide-1.2
gtk  gnomapps     ADD   # gnome-applets-1.2.1
gtk  gnomcore     ADD   # gnome-core-1.2.1
gtk  gnomedia     ADD   # gnome-media-1.2.0
gtk  gnomeicu     ADD   # gnomeicu-0.93
gtk  gnomenet     ADD   # gnome-network-1.0.2
gtk  gnomepim     ADD   # gnome-pim-1.2.0
gtk  gnometop     REC   # gtop-1.0.9
gtk  gnomlibs     ADD   # gnome-libs-1.2.1
gtk  gnomobjc     ADD   # gnome-objc-1.0.40
gtk  gnoprint     ADD   # gnome-print-0.20
gtk  gnotepad     ADD   # gnotepad+-1.3.1
gtk  gnoutils     ADD   # gnome-utils-1.2.0
gtk  gnpython     ADD   # gnome-python-1.0.53
gtk  gnumeric     ADD   # gnumeric-0.54
gtk  gqmpeg       REC   # gqmpeg-0.6.3
gtk  gtkeng       ADD   # gtk-engines-0.10
gtk  gtkglib      ADD   # gtk+-1.2.8, glib-1.2.8
gtk  guile        ADD   # guile-1.3.4
gtk  imlib        ADD   # imlib-1.9.8.1
gtk  libghttp     ADD   # libghttp-1.0.6
gtk  libglade     ADD   # libglade-0.13
gtk  libgtop      ADD   # libgtop-1.0.9
gtk  librep       ADD   # librep-0.11.3
gtk  libungif     ADD   # libungif-4.1.0
gtk  libxml       ADD   # libxml-1.8.7
gtk  orbit        ADD   # ORBit-0.5.1
gtk  repgtk       ADD   # rep-gtk-0.10
gtk  sawfish      ADD   # sawfish-0.28
gtk  wmaker       ADD   # WindowMaker-0.62.1
gtk  xchat        ADD   # xchat-1.2.1
gtk  xscrsave     ADD   # xscreensaver-3.24

k    *            SKP
k    linuxinc     REC   # Linux 2.2.16 kernel include files.
k    lx2216       REC   # Linux kernel source version 2.2.16.
...
kde  qt_1_45      ADD   # Qt-1.45

n    *            SKP
n    apache       OPT   # Apache WWW server v 1.3.12
n    bind         REC   # bind-8.2.2-P5
n    dip          OPT   # DIP - dialup IP connection handler 3.3.7p
n    elm          OPT   # Menu-driven user mail program. (v. 2.5.3)
n    ftchmail     OPT   # fetchmail-5.4.0
n    imapd        OPT   # imapd (IMAP4rev1 v12.264 from pine4.21)
n    inn          OPT   # INN-STABLE-20000614 (2.2.2+bugfixes)
...
n    netmods      ADD   # Network support modules for linux-2.2.16.
n    netpipes     OPT   # netpipes 4.2
n    nn_nntp      OPT   # nn-6.5.1 compiled to use NNTP.
n    pine         OPT   # Pine version 4.21
n    ppp          OPT   # PPP for Linux, version 2.3.11
n    procmail     OPT   # The procmail mail processing program. (v3.14 1999/11/22)
n    rdist        OPT   # rdist-6.1.4.
n    rsync        OPT   # rsync-2.4.3
n    samba        OPT   # Samba 2.0.7
n    sendmail     REC   # sendmail 8.10.2.
n    smailcfg     OPT   # Configuration files for sendmail.
n    tcpdump      REC   # tcpdump-3.4
...
tcl  *            SKP
tcl  expect       OPT   # expect-5.31.
tcl  hfsutils     OPT   # hfsutils-3.2.6.
tcl  tcl          ADD   # The Tcl script language, version 8.3.1.
tcl  tclx         REC   # Extended Tcl (TclX) 8.2.0.
tcl  tix          OPT   # Tix4.1.0.006.
tcl  tk           REC   # The Tk toolkit for Tcl, version 8.3.1.

x    *            SKP
x    fvwm2        ADD   # fvwm-2.2.4
x    fvwmicns     OPT   # xpm3icons.
x    lesstif      REC   # LessTif 0.89.9 (A Motif 1.2 alternative)
...
x    xbin         ADD   # Basic client binaries required for XFree86 3.3.6.
x    xcfg         ADD   # Configuration files for XFree86 3.3.6.
x    xdoc         REC   # Documentation and release notes for XFree86 3.3.6.
x    xf100        OPT   # 100-dpi screen fonts.
x    xfcyr        OPT   # Cyrillic fonts for XFree86 3.3.6.
...
x    xjdoc        OPT   # Japanese documentation and release notes for XFree86 3.3.6.
x    xlib         ADD   # Various library files for XFree86 3.3.6.
x    xlock        ADD   # xlockmore-4.16.1
...
x    xman         REC   # Man pages for XFree86 3.3.6.
...
x    xprt         OPT   # Print-only server (Xprt) for XFree86 3.3.6.
...
xap  gv           REC   # gv 3.5.8
xap  imagick      REC   # ImageMagick-5.1.1
xap  netscape     REC   # Netscape Communicator 4.73 (communicator-v473.x86-unknown-linux2.2)
