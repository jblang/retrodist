This is Slackware Linux 3.6.0.

This version contains the 2.0.35 Linux kernel, plus recent versions of these
(and other) software packages:

- Kernel modules         2.0.35
- PPP daemon             2.2.0f and 2.3.5
- Dynamic linker (ld.so) 1.9.9
- C compiler             egcs-1.0.3 and gcc-2.7.2.3
- Binutils               2.8.1.0.23
...
- Gpm                    1.14
- SysVinit               2.73
- Shadow Password Suite  shadow-980724
- Util-linux             2.7.1
- X Window System        XFree86 3.3.2 + patch 3
...
slakware/a1 - slakware/a13:  The base system.  Enough to get up and running and
                have elvis and comm programs available.  Based around the 2.0.35
...
slakware/d1:    Program development.  egcs-1.0.3 (gcc-2.8 based C/C++/f77/
                ...
                perl, python-1.5.1, rcs.

slakware/e1:    GNU Emacs 20.3.

slakware/f1:    A collection of FAQs and other documentation.

slakware/k1:    Source code for the 2.0.35 Linux kernel.

slakware/n1 - slakware/n9:   Networking. TCP/IP, UUCP, mailx, dip, PPP,
                deliver, elm, pine, BSD sendmail, Apache httpd, arena, lynx,
                cnews, nn, tin, trn, inn.
...
slakware/x1:    The base XFree86 3.3.2 + patch 3 system, with libXpm,
...
slakware/xap1:  X applications: X11 ghostscript, libgr, seyon, workman, 
                xfilemanager, xv 3.10a, GNU chess and xboard, gimp, xfm 1.3.2,
