...
a    gpm          REC   # General purpose mouse support v1.13
a    grep         ADD   # GNU grep 2.1
a    gzip         ADD   # GNU zip compression utilities. (v. 1.2.4)
a    hdsetup      ADD   # The Slackware setup/package maintenance system v. 3.5.0
a    ibcs2        OPT   # Intel Binary Compatibility Specification module
a    ide          REC   # Linux kernel version 2.0.34, without SCSI support.
...
a    modules      ADD   # Linux kernel modules for 2.0.34.
a    modutils     ADD   # modutils-2.1.85
a    pcmcia       REC   # pcmcia-cs-3.0.0
a    pnp          OPT   # isapnptools-1.15
a    procps       ADD   # procps-1.2.7
a    scsi         REC   # Linux kernel version 2.0.34, with SCSI support.
a    scsimods     ADD   # Linux SCSI kernel modules for 2.0.34.
a    sh_utils     ADD   # GNU sh-utils-1.16
a    shadow       ADD   # Shadow password suite (shadow-980529)
...
ap   jpeg6        OPT   # Independent JPEG Group's JPEG software version 6a
ap   manpages     REC   # Man-pages 1.18 (on-line Linux documentation)
...
e    emacinfo     REC   # Info files for emacs-20.2
e    emacmisc     REC   # Miscellaneous files for emacs-20.2.
e    emacsbin     ADD   # GNU Emacs 20.2
...
k    *            SKP
k    linuxinc     REC   # Linux 2.0.34 kernel include files.
k    lx2034       REC   # Linux kernel source version 2.0.34.

n    *            SKP
n    apache       OPT   # Apache WWW server v 1.2.6
...
n    samba        OPT   # Samba 1.9.18p7
n    sendmail     REC   # BSD sendmail 8.9.0.
...
xap  ghstview     REC   # Ghostview 1.5
xap  gimp         OPT   # The GIMP -- GNU Image Manipulation Program version 0.99.23
xap  gnuplot      OPT   # gnuplot 3.5
xap  gs_x11       REC   # Replacement /usr/bin/gs with X11 options compiled in.
xap  libgr        REC   # libgr-2.0.12
xap  netscape     REC   # Netscape Communicator 4.05. (v405-export.x86-unknown-linux2.0)
xap  qt_1_33      OPT   # Qt-1.33
