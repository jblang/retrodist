This is Slackware Linux 3.5.0.

This version contains the 2.0.34 Linux kernel, plus recent versions of these
(and other) software packages:

- Kernel modules         2.0.34
...
slakware/a1 - slakware/a11:  The base system. Enough to get up and running and
                have elvis and comm programs available. Based around the 2.0.34
                Linux kernel, and concepts from the Linux filesystem standard. 
...
slakware/ap1:   Various applications and add ons, such as the manual pages,
                groff, ispell, joe, jed, jove, ghostscript, sc, bc, and the
                quota patches.

slakware/d1:    Program development.  egcs-1.0.3 (gcc-2.8 based C/C++/f77/
                Objective-C compiler from egcs.cygnus.com), make (GNU and BSD),
                byacc and GNU bison, flex, 5.4.44 C libraries, gdb, SVGAlib,
                ncurses, gcl (LISP), p2c, m4, perl, python, rcs.

slakware/e1:    GNU Emacs 20.2.

slakware/f1:    A collection of FAQs and other documentation.

slakware/k1:    Source code for the 2.0.34 Linux kernel.

slakware/n1:    Networking. TCP/IP, UUCP, mailx, dip, PPP, deliver, elm, pine, 
                BSD sendmail, Apache httpd, arena, lynx, cnews, nn, tin, trn,
                inn.

slakware/t1:    teTeX Release 0.4 - teTeX is Thomas Esser's TeX distribution
                for Linux.

slakware/tcl1:  Tcl, Tk, TclX, built with ELF shared libraries and dynamic
                loading support.
...
slakware/x1:    The base XFree86 3.3.2 + patch2 system, with libXpm,
...
slakware/xap1:  X applications: X11 ghostscript, libgr, seyon, workman, 
                xfilemanager, xv 3.10a, GNU chess and xboard, xfm 1.3.2,
                Netscape Communicator, ghostview, gnuplot, xpaint, xfractint,
                fvwm95, TkDesk filemanager, and various X games. 

slakware/xd1:   X11 server linkkit, static libraries, and PEX support.

slakware/xv1:   xview3.2p1-X11R6. XView libraries, and the Open Look 
...
zipslack        This directory contains ZipSlack, a version of Slackware
                supplied as a single 34 megabyte ZIP archive.  Installation
