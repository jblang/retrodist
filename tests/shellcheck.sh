...
HOST_SCRIPTS=(retro jump qmp retrolib/*.sh slackware/sysinstall.sh slackware/pkgtool.sh debian/dinstall.sh tests/*.sh)
...
GUEST_SCRIPTS=(autoinst/*.sh autoinst/install/*.sh autoinst/config/*.sh autoinst/deb091/*.sh)
