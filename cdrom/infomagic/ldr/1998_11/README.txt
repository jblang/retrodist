...
And as a NEW and SEPARATE PRODUCT, the Linux Archive CDROM, 
...
InfoMagic is please to announce that all 4 distributions are bootable
directly from the CDROM on supported hardware!
...
Our mirrors were frozen:
	...
	November 10th, 1998:	
		...
		Red Hat 5.2
		Red Hat updates for 5.2
		S.u.S.E 5.3
		Slackware 3.6
		Debian  2.0_r3
		Debian Source 2.0_r3
		Debian Contrib 2.0_r3
		Netscape 4.5
		Real Audio Player 5.0 (free version)

Red Hat 5.2 for Intel including sources and updates:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

DISK 1: Red Hat 5.2
        Red Hat 5.2 updates
	Red Hat 5.2 Source, Part 2
DISK 6: Red Hat 5.2 Source, Part 1
...
S.u.S.E 5.3 Binaries and Sources
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
DISK 3: Debian 2.0_r3 Binaries
DISK 5: Debian 2.0_r3 Sources
DISK 6: Debian 2.0_r3 Contrib
...
Slackware 3.6 (aka Slackware 96) and sources.  
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

DISK 4: Slackware Binaries, Source and Contrib
...
The boot and root images are in bootdsks.144.  As of 
Slackware 3.5 and greater, 1.2MB floppies are no longer
fully supported.  Please Disc4/README for more information.
...
Slackware was mirrored on November 9th and reflects the last known
...
Metro-X 4.x Enhanced Server Set (in tar and rpm format)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Metro-X has been discontinued.  However, let us know if you wish to
see the MetroX server included on future releases.  We are currently
not aware of what the demand is for Metro-X since most video cards are
supported directly by XFree86.

Kernel sources to version 2.0.36 and 2.1.127:  
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Please note that kernel 2.0.36 was still an unofficial kernel included
with Red Hat 5.2.  It is based on Alan Cox's patches.

For a complete copy of the ftp.kernel.org archives, please see our new
product, the Linux Archive CDROM set.  We have provided only 2.0.36
and 2.1.127 on the LDR.

General Information about the Linux Developer's Resource
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

These discs are published every 3-4 months (or so) and include only
install-able distributions of Linux.  We have a separate product called
the Linux Archives which contain things like sunsite, tsx-11, GNU and
the kernel archives.

NOTES: 
Some popular packages have been removed due to copyright
restrictions, these include: Mosaic, kermit, xv, and Chimera.  We
apologize for the inconvenience.  These (and more) can of course be
found on our FTP server, ftp.infomagic.com (165.113.211.32) in
/pub/mirrors/linux/.
...
Notes for New Comers
~~~~~~~~~~~~~~~~~~~

On Disc 1 in the "doc/HOWTO/" directory are a series of HOWTO
documents that provide detailed instructions on how to configure and
install nearly every aspect of Linux.  Please refer to these before
starting if you have never done it before !  These documents are in
UNIX(tm) format which means they do not end in CRLF, only LF and will
therefore not print on most DOS systems.  You will need to view them
with an editor or word processor.
...
RoadMap
~~~~~~~
disc1				Red Hat 5.2 release for Intel and
				part 2 of the Red Hat 5.2 source tree
disc1/doc/HOWTO			English version How To Documents from
disc1/doc/FAQ			English version Frequently Ask Questions

disc2				SuSE 5.3 with source	

disc3				Debian Binary CD for 2.0_r3	
disc3/ftp.netscape.com		Supported and Unsupported versions
				of Netscape 4.5 for Linux.
disc3/realaudio			Real Audio Player 5.0 (freeware version)
				in *.tar.gz and *.rpm formats.

disc4				Slackware 3.6 Release with source
				and contrib.

disc4/ftp.kernel.org		version 2.0.35 and 2.1.127 from
				ftp.kernel.org

disc5				Debian Source CD for 2.0_r3

disc6				Debian Contrib 2.0_r3
disc6/RedHat			Red Hat 5.2 sources, part 1
